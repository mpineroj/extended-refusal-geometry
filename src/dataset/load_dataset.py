...
SPLIT_DATASET_FILENAME = os.path.join(dataset_dir_path, '../../data/saladbench_splits/{harmtype}_{split}.json')
PROCESSED_DATASET_FILENAME = os.path.join(dataset_dir_path, '../../data/processed/{dataset_name}.json')
...
def load_dataset(dataset_name, instructions_only: bool=False):
    ...
    file_path = PROCESSED_DATASET_FILENAME.format(dataset_name=dataset_name)
